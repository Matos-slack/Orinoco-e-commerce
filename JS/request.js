...
// Affichage dynamique chaque Page //
    ...
    function orders(id) {
        ...
        if (id == order.orderId) {
            ...
            let total = 0;
            Object.values(order.products).map(items => {      //Object.values renvoie un tableau contenant les valeurs des propriétés d'un objet dont l'ordre est le même que celui obtenu avec une boucle
                                                            //La méthode map() crée un nouveau tableau avec les résultats de l'appel d'une fonction fournie sur chaque élément du tableau appelant.
...
// Gestion propriété et quantité des produits //

    //Boucle Ajouter au panier 
    ...
    // Fonction ajout produit dans localstorage et proprieté incart en fonction de son id
    function itemPanier() {
...
// Gestion du Panier et validation formulaire //
    ...
    function ValidReg() {
        ...
        if (valid) {
            ...
            // Recupération des proprietés et valeurs des produits dans le panier
